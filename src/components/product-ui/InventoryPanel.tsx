...
export function InventoryPanel() {
  return (
    ...
    >
      <div className="p-4">
        <div className="grid grid-cols-[1.6fr,repeat(3,1fr),auto] gap-2 border-b border-line pb-2 font-mono text-[10px] uppercase tracking-wider text-ink-muted">
        ...
        <ul className="divide-y divide-line/70">
          {rows.map((r) => (
            <li key={r.item} className="grid grid-cols-[1.6fr,repeat(3,1fr),auto] items-center gap-2 py-2 text-xs">
